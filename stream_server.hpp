...
class peer_connection
{
    ...
    peer_connection(const peer_connection & other)
            :s(other.get_socket()), peer_node(other.get_peer_node()),
...
void launch_service(peer_connection & conn, service_fun_t service);
#endif
